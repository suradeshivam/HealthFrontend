...
export default function Invoiceview() {
  return (
    <>
      ...
      {/* Mirrored from TwinsisTech.dreamstechnologies.com/html/template/invoice-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Apr 2024 16:47:27 GMT */}
    </>
