...
export default function Medicalrecords() {
    ...
    <div className="content">
      ...
      {tableData.map(item => (
        <tr key={item.id}>
          ...
          <td>{item.name}</td>
          <td>
            {item.date} <span className="d-block text-info">{convertTimeTo12HourFormat(item.time)}</span>
          </td>
          <td>{item.doctor}</td>
  ...
  <div
    ...
    aria-hidden="true"
  >
    <div className="modal-dialog modal-dialog-centered modal-lg" role="document" style={{ marginTop: "110px" }}>
          ...
          <div className="modal-body">
            ...
            <div className="row">
              ...
              <div className="col-12">
                <div className="mb-3">
                  <label className="mb-2">Doctor Name (Treatment done by)</label>
                  <input
                    type="text"
                    name="doctor"
                    className="form-control"
