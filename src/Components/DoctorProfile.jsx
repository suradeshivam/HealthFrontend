            ...
            <div className="col-md-7 col-lg-8 col-xl-9">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <label className="mb-2">
                  Please ensure your certifications are up-to-date and relevant to your role as a physician, prioritizing the most recent qualifications and achievements.
                          </label>
                  <div className="row">
